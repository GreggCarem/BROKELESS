 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{static fromTimestamp(t){return new It(t)}static min(){return new It(new Ae(0,0))}static max(){return new It(new Ae(253402300799,999999999))}constructor(t){this.timestamp=t}compareTo(t){return this.timestamp._compareTo(t.timestamp)}isEqual(t){return this.timestamp.isEqual(t.timestamp)}toMicroseconds(){return 1e6*this.timestamp.seconds+this.timestamp.nanoseconds/1e3}toString(){return"SnapshotVersion("+this.timestamp.toString()+")"}toTimestamp(){return this.timestamp}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
}`);var Io=Array.from({length:4},function(n,t){return"--riple-phase".concat(t+1,"-color")}),S9=function(n){var t,e=T2(n==null?void 0:n.style,n==null?void 0:n.size),i=e.styles,s=e.fontSize,l=n==null?void 0:n.easing,c=E2(n==null?void 0:n.speedPlus,"1s").animationPeriod,d=function(p){var g={};if(p instanceof Array){for(var v=w2(p,Io.length),A=0;A<v.length&&!(A>=4);A++)g[Io[A]]=v[A];return g}try{if(typeof p!="string")throw new Error("Color String expected");for(var E=0;E<Io.length;E++)g[Io[E]]=p}catch(k){for(k instanceof Error?console.warn("[".concat(k.message,']: Received "').concat(typeof p,'" instead with value, ').concat(JSON.stringify(p))):console.warn("".concat(JSON.stringify(p)," received in <Riple /> indicator cannot be processed. Using default instead!")),E=0;E<Io.length;E++)g[Io[E]]=hv}return g}((t=n==null?void 0:n.color)!==null&&t!==void 0?t:"");return Ee.createElement("span",{className:"rli-d-i-b riple-rli-bounding-box",style:fn(fn(fn(fn(fn({},s&&{fontSize:s}),c&&{"--rli-animation-duration":c}),l&&{"--rli-animation-function":l}),d),i),role:"status","aria-live":"polite","aria-label":"Loading"},Ee.createElement("span",{className:"rli-d-i-b riple-indicator"},Ee.createElement("span",{className:"rli-d-i-b riple"}),Ee.createElement("span",{className:"rli-d-i-b riple"}),Ee.createElement(A2,{className:"riple-text",text:n==null?void 0:n.text,textColor:n==null?void 0:n.textColor})))};Ve(`.pulsate-rli-bounding-box {
...
}`);var Xh=Array.from({length:4},function(n,t){return"--trophySpin-phase".concat(t+1,"-color")}),R9=function(n){var t,e=T2(n==null?void 0:n.style,n==null?void 0:n.size),i=e.styles,s=e.fontSize,l=n==null?void 0:n.easing,c=E2(n==null?void 0:n.speedPlus,"2.5s").animationPeriod,d=function(p){var g={},v=Xh.length;if(p instanceof Array){for(var A=w2(p,v),E=0;E<A.length&&!(E>=4);E++)g[Xh[E]]=A[E];return g}try{if(typeof p!="string")throw new Error("Color String expected");for(var k=0;k<v;k++)g[Xh[k]]=p}catch(x){for(x instanceof Error?console.warn("[".concat(x.message,']: Received "').concat(typeof p,'" instead with value, ').concat(JSON.stringify(p))):console.warn("".concat(JSON.stringify(p)," received in <TrophySpin /> indicator cannot be processed. Using default instead!")),k=0;k<v;k++)g[Xh[k]]=hv}return g}((t=n==null?void 0:n.color)!==null&&t!==void 0?t:"");return Ee.createElement("span",{className:"rli-d-i-b trophy-spin-rli-bounding-box",style:fn(fn(fn(fn(fn({},s&&{fontSize:s}),c&&{"--rli-animation-duration":c}),l&&{"--rli-animation-function":l}),d),i),role:"status","aria-live":"polite","aria-label":"Loading"},Ee.createElement("span",{className:"rli-d-i-b trophy-spin-indicator"},Ee.createElement("span",{className:"blade"}),Ee.createElement("span",{className:"blade"}),Ee.createElement("span",{className:"blade"}),Ee.createElement("span",{className:"blade"}),Ee.createElement("span",{className:"blade"}),Ee.createElement("span",{className:"blade"}),Ee.createElement("span",{className:"blade"}),Ee.createElement("span",{className:"blade"})),Ee.createElement(A2,{staticText:!0,text:n==null?void 0:n.text,textColor:n==null?void 0:n.textColor}))};Ve(`.slab-rli-bounding-box {
